...
class IndicatorLevel1Type extends AbstractType
{
    protected $request;
    protected $em;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        $resolver->setDefaults(array(
            'class'    => 'Srm\CoreBundle\Entity\IndicatorLevel1',
            'property' => 'label',
            'label'    => 'repositories.list.categories',
            'choices'  => $categories,
            'multiple' => true,
        ));
    }
    ...
    {
        return 'srm_organisation_indicatorLevel1';
    }
}
